...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { about: @resume.about, age: @resume.age, email: @resume.email, name: @resume.name, picture: @resume.picture, surname: @resume.surname } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { about: @resume.about, age: @resume.age, email: @resume.email, name: @resume.name, picture: @resume.picture, surname: @resume.surname } }
